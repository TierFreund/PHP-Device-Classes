...
File:  
	...
	Date     : 2015-03-22T23:28:28+01:00
	Version  : 1.00.45
...
Device:
	...
	URL 		 : http://192.168.112.61:8080/description.xml	
	Friendly Name: sony
...
class SonyPlayerUpnpDevice {
    ...
    public function __construct($url){
        ...
        $this->_SERVICES->RenderingControl=new SonyPlayerRenderingControl($this);
        $this->_SERVICES->ConnectionManager=new SonyPlayerConnectionManager($this);
        $this->_SERVICES->AVTransport=new SonyPlayerAVTransport($this);
        $this->_SERVICES->IRCC=new SonyPlayerIRCC($this);
        $this->_SERVICES->X_Tandem=new SonyPlayerX_Tandem($this);
        $this->_DEVICES->X_CIS=new SonyPlayerX_CIS($this);
    }
    /***************************************************************************
    /* Funktion : GetIcon
    /* 
    ...
    function GetIcon($id) {
        switch($id){
            case 0 : return array('width'=>48,'height'=>48,'url'=>'http://192.168.112.61:8080/device_icon_48.jpg');break;
            case 1 : return array('width'=>120,'height'=>120,'url'=>'http://192.168.112.61:8080/device_icon_120.jpg');break;
            case 2 : return array('width'=>48,'height'=>48,'url'=>'http://192.168.112.61:8080/device_icon_48.png');break;
            case 3 : return array('width'=>120,'height'=>120,'url'=>'http://192.168.112.61:8080/device_icon_120.png');break;
        }
...
/*##########################################################################*/
class SonyPlayerRenderingControl extends SonyPlayerUpnpClass {
...
/*##########################################################################*/
class SonyPlayerConnectionManager extends SonyPlayerUpnpClass {
...
/*##########################################################################*/
class SonyPlayerAVTransport extends SonyPlayerUpnpClass {
...
/*##########################################################################*/
class SonyPlayerIRCC extends SonyPlayerUpnpClass {
...
/*##########################################################################*/
class SonyPlayerX_Tandem extends SonyPlayerUpnpClass {
...
/*##########################################################################*/
class SonyPlayerX_CIS extends SonyPlayerUpnpClass {

...
File:  
	...
	Date     : 2015-03-22T23:28:53+01:00
	Version  : 1.00.45
...
Device:
	...
	URL 		 : http://192.168.112.61:8000/serverxml.xml	
	Friendly Name: sony
	Manufacturer : Sony Corporation
	URL 		 : http://www.sony.net/
	Model        : MULTI CHANNEL AV RECEIVER
	Name 		 : STR-DN1050
	Number 		 : 
	URL 		 : 
	Serialnumber : 
	UDN          : uuid:5f9ec1b3-ed59-1900-4532-d8d43cd2af47

/*--------------------------------------------------------------------------*/
/*##########################################################################/
/*  Class  : SonyServerUpnpDevice 
...
class SonyServerUpnpDevice {
    ...
    protected $_IP='';
    protected $_PORT=8000;
    /***************************************************************************
    /* Funktion : __construct
    /* 
    /*  Benoetigt:
    /*    @url (string)  Device Url eg. '192.168.112.61:8000'
    /*
    ...
    public function __construct($url){
        ...
        $this->_PORT=(isSet($p['port']))?$p['port']:8000;
        $this->_SERVICES=new stdClass();
        $this->_DEVICES=new stdClass();
        $this->_SERVICES->ContentDirectory=new SonyServerContentDirectory($this);
        $this->_SERVICES->ConnectionManager=new SonyServerConnectionManager($this);
    }
    /***************************************************************************
    /* Funktion : GetIcon
    /* 
    ...
    function GetIcon($id) {
        switch($id){
            case 0 : return array('width'=>48,'height'=>48,'url'=>'http://192.168.112.61:8000/device_icon_48.jpg');break;
            case 1 : return array('width'=>120,'height'=>120,'url'=>'http://192.168.112.61:8000/device_icon_120.jpg');break;
            case 2 : return array('width'=>48,'height'=>48,'url'=>'http://192.168.112.61:8000/device_icon_48.png');break;
            case 3 : return array('width'=>120,'height'=>120,'url'=>'http://192.168.112.61:8000/device_icon_120.png');break;
        }
...
/*##########################################################################*/
class SonyServerContentDirectory extends SonyServerUpnpClass {
    protected $SERVICE='urn:schemas-upnp-org:service:ContentDirectory:1';
    protected $SERVICEURL='/ContentDirectory_ctrl';
    protected $EVENTURL='/ContentDirectory_evt';
    /***************************************************************************
    ...
    /*
    /****************************************************************************/
    public function X_GetOperationList($ObjectID){
    ...
    /*
    /****************************************************************************/
    public function X_ExecuteOperation($ObjectID, $ActionDirective){
        $args="<ObjectID>$ObjectID</ObjectID><ActionDirective>$ActionDirective</ActionDirective>";
        $filter="Result,UpdateID";
...
/*##########################################################################*/
class SonyServerConnectionManager extends SonyServerUpnpClass {
    protected $SERVICE='urn:schemas-upnp-org:service:ConnectionManager:1';
    protected $SERVICEURL='/ConnectionManager_ctrl';
    protected $EVENTURL='/ConnectionManager_evt';
    /***************************************************************************
